...
export const metadata: Metadata = {
  ...
  keywords: [
    'desarrollo web', 'Next.js', 'React', 'portfolio', 'Camilo Escar',
    'Desarrollador React Argentina', 'Desarrollador Next.js Argentina',
    'Backend Laravel Argentina', 'Full Stack Developer Entre Ríos',
    'Desarrollo de sistemas empresariales', 'CRM ERP a medida',
  ],
  ...
  openGraph: {
    ...
    locale: 'es_ES',
    images: [{ url: 'https://raw.githubusercontent.com/CamiloEscar/CamiloEscar/main/assets/profile.jpg', width: 1200, height: 630, alt: 'Camilo Escar - Portfolio' }],
  },
  twitter: {
